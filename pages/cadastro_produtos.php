    ...
    <form action="api/cadastrar_produtos.php" method="POST" class="space-y-4 flex-1 flex flex-col">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
                ...
                <div class="relative">
                    ...
                    <input type="text" id="sku_produto" name="sku" placeholder="Ex: PRD-001" required 
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input type="text" id="nome_produto" name="nome" placeholder="Ex: Teclado Mecânico" required 
                           class="w-full bg-estokei-bg border border-white/10 rounded-xl py-3 pl-10 pr-4 text-sm focus:outline-none focus:border-estokei-accent focus:ring-1 focus:ring-estokei-accent transition-all text-white placeholder-estokei-textMuted">
                </div>
            </div>
        </div>
        ...
        <div>
            ...
            <div class="relative">
                ...
                <input type="text" id="descricao_produto" name="descricao" placeholder="Breve descrição do produto..." 
                       class="w-full bg-estokei-bg border border-white/10 rounded-xl py-3 pl-10 pr-4 text-sm focus:outline-none focus:border-estokei-accent focus:ring-1 focus:ring-estokei-accent transition-all text-white placeholder-estokei-textMuted">
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
                ...
                <div class="relative">
                    ...
                    <input type="number" id="quantidade_atual" name="quantidade_atual" placeholder="0" required 
                           class="w-full bg-estokei-bg border border-white/10 rounded-xl py-3 pl-10 pr-4 text-sm focus:outline-none focus:border-estokei-accent focus:ring-1 focus:ring-estokei-accent transition-all text-white placeholder-estokei-textMuted">
                </div>
            </div>
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input type="number" id="estoque_minimo" name="estoque_minimo" placeholder="Ex: 10" required 
                           class="w-full bg-estokei-bg border border-white/10 rounded-xl py-3 pl-10 pr-4 text-sm focus:outline-none focus:border-estokei-accent focus:ring-1 focus:ring-estokei-accent transition-all text-white placeholder-estokei-textMuted">
                </div>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
                ...
                <div class="relative">
                    ...
                    <input type="number" step="0.01" id="preco_custo" name="preco_custo" placeholder="0.00" required 
                           class="w-full bg-estokei-bg border border-white/10 rounded-xl py-3 pl-10 pr-4 text-sm focus:outline-none focus:border-estokei-accent focus:ring-1 focus:ring-estokei-accent transition-all text-white placeholder-estokei-textMuted">
                </div>
            </div>
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input type="number" step="0.01" id="preco_venda" name="preco_venda" placeholder="0.00" required 
                           class="w-full bg-estokei-bg border border-white/10 rounded-xl py-3 pl-10 pr-4 text-sm focus:outline-none focus:border-estokei-accent focus:ring-1 focus:ring-estokei-accent transition-all text-white placeholder-estokei-textMuted">
                </div>
            </div>
        </div>
        ...
        <div>
            ...
            <div class="relative">
                ...
                <input type="text" id="localizacao_produto" name="localizacao" placeholder="Ex: Corredor A - Prateleira 3" 
                       class="w-full bg-estokei-bg border border-white/10 rounded-xl py-3 pl-10 pr-4 text-sm focus:outline-none focus:border-estokei-accent focus:ring-1 focus:ring-estokei-accent transition-all text-white placeholder-estokei-textMuted">
            </div>
        </div>
